...
<Box display='flex' flexWrap='wrap' alignContent='stretch' justifyContent="space-between" overflow='auto' m='1rem'>
      <Box  maxWidth='20rem' maxHeight='50rem' height='100%'>
      <WidgetWraper flexDirection='row-reverse' m='2rem 0 0 0' padding='0rem 0'>

        <Typography fontFamily='Roboto'  m='20rem 0 0 0' 
          fontSize="3.52rem" >
          # Trending
        </Typography>
      </WidgetWraper>
